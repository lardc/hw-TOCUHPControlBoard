...
// 25 - 29
#define REG_PRE_PULSE					30	// Маска записи в сдвиговый регистр перед формированием импульса
#define REG_PRE_PULSE_DELAY			    31	// Таймаут записи в сдвиговый регистр перед формированием импульса, мс
// 31 - 59
