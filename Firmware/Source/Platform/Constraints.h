...
#define SYNC_WAIT_TIMEOUT_MIN		0		// ג לס
#define SYNC_WAIT_TIMEOUT_MAX		10000	// ג לס
#define SYNC_WAIT_TIMEOUT_DEF		20		// ג לס

#define AFTER_PULSE_TIMEOUT_MIN		500		// ג לס
#define AFTER_PULSE_TIMEOUT_MAX		30000	// ג לס
#define AFTER_PULSE_TIMEOUT_DEF		1000	// ג לס
